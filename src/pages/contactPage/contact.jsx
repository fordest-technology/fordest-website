  ...
  return (
    <>
      <div className="contact-header p-5">
        <h1 className="text-4xl text-white text-center sm:text-3xl">
          Contact Us
        </h1>
        <div className="underline"></div>
        <p className="text-white text-center  sm:text-sm">
      ...
      <div className="contact-body flex gap-5 justify-between p-10 flex-wrap 2lg:p-6 sm:p-4">
        <div className="contact-body-left w-50 lg:w-2/4 md:w-full">
          ...
          <h1 className="font-bold text-4xl text-blue-900 lg:w-100 lg:text-3xl">
        ...
        <div className="contact-body-right border-2 border-solid border-gray-200 rounded-md px-10 py-12 md:w-full">
          <div className="form">
            ...
            <h2 className="text-blue-700 font-bold text-4xl xl:text-2xl">
              Send Us A Message
            </h2>
            <form action="" className="flex flex-col gap-2">
              ...
              <input
                type="text"
                id="name"
                className=" p-2 border-2  border-solid border-gray-200 rounded-md  h-10 outline-blue-600  xl:w-64 md:w-full"
              />
              ...
              <textarea
                name=""
                id="message"
                className=" p-2 border-2  border-solid border-gray-200 rounded-md h-20 outline-blue-600 xl:w-64 md:w-full"
              ></textarea>
              <input
                type="submit"
                name=""
                id=""
                className="border-2  border-solid border-green rounded-md  h-10 bg-green-600 text-white xl:w-64 md:w-full font-bold transition:100 cursor:pointer hover:bg-white hover:text-green-600 hover:border-2 hover:border-solid hover:border-green-600 "
              />
            </form>
          </div>
        </div>
      ...
      <div className="contact-info p-12 grid grid-cols-2 justify-between gap-10 sm:grid-cols-1 2lg:p-6 sm:p-4">
        <div className="caard1 grid gap-1">
          ...
          <div className="contact-detail flex gap-2">
            <img src={mail} alt="" />{" "}
            <p className="text-sm"> info@fordestech.com</p>
          </div>
          <div className="contact-detail flex gap-2">
        ...
        <div className="card2">
          ...
          <p className="text-sm">
            ...
            opportunities, or would like to discuss a potential project, our
            sales team is ready to assist you.
          </p>
          <div className="contact-detail flex gap-2">
            <img src={mail} alt="" />{" "}
            <p className="text-sm">sales@fordestech.com</p>
          </div>
        </div>
        <div className="card3">
          <h2 className="text-blue-800 font-bold text-xl ">
          ...
          <p className="text-sm">
            If you prefer face-to-face communication, you are welcome to visit
          ...
          <div className="address flex gap-2">
            ...
            <div className="address-info">
              <p className="text-sm">
                Fordest Techoloy <br /> 30 liasu road Ikotun <br /> lagos state,
                NIgeria
              </p>
            </div>
          </div>
        ...
        <div className="crd4">
          ...
          <p className="text-sm">
            We're Here to Help: <br /> Whether you have a question about our
            services, want to explore partnership opportunities, or need
            assistance with an existing project, we're here to help. Please
            don't hesitate to reach out using the contact information provided
