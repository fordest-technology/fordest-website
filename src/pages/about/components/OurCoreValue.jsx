  ...
  return (
    <div className="w-full flex flex-col items-center px-4 md:px-8 lg:px-16">
      ...
      >
        <motion.h2
          variants={headerVariants}
          className="text-[#0B0C3A] text-2xl md:text-3xl lg:text-4xl font-bold text-center"
        >
          Our Core Values
        </motion.h2>
        <motion.div
        ...
        <motion.p
          variants={headerVariants}
          className="text-[#0B0C3A] text-md md:text-lg lg:text-xl font-medium text-center max-w-[880px]"
        >
      ...
      <div className="w-full bg-blue flex flex-col py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mx-auto w-full max-w-5xl px-4">
          {/* Card 1 */}
          <motion.div
            className="flex flex-col gap-2 justify-center items-center bg-white rounded-md py-8 px-6 shadow-md"
